...
const DashboardPage = () => {
  ...
  //   console.log(role, isLoading)
    ...
    return (
        ...
        {/* Sidebar */}
        <div
          className={`bg-gray-100 fixed  z-10  flex-col justify-between overflow-x-hidden  min-h-[calc(100vh-300px)]  w-64 space-y-6 px-2  py-4   inset-y-0 left-0 transform ${
