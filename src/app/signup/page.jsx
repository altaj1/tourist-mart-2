      ...
      <div className="relative z-10 lg:ml-64 p-5 text-yellow-50 flex items-center pt-36 flex-col h-full">
        ...
        <div className="bg-slate-50 bg-opacity-30 p-10 rounded-sm mt-16 shadow-lg">
          <form className="space-y-4" onSubmit={handleSignUp}>
            <div className="flex flex-col text-gray-800">
              <label className="font-semibold text-yellow-50">Name*</label>
              <input
                required
                type="text"
                name="name"
            ...
            <div className="flex flex-col">
              <label className="font-semibold text-yellow-50">Email*</label>
              <input
                required
                type="email"
                name="email"
            ...
            <div className="flex flex-col">
              <label className="font-semibold text-yellow-50">Password*</label>
              <input
                required
                type="password"
                name="password"
